...
export default class Enemy extends MatterEntity {
    constructor(data) {
        ...
        let enemyCollider = Bodies.circle(this.x, this.y, 12, { isSensor: false, labe: 'enemyCollider' })
        let enemySensor = Bodies.circle(this.x, this.y, 80, { isSensor: true, labe: 'enemyCollider' })
